  ...
  return (
    <div
      className={clsx(
        ...
        "my-1 mr-2 rounded-lg bg-yellow-600 p-2 text-xs shadow-depth-1 hover:border-[#1E88E5]/40 sm:mr-4 sm:p-3",
        "sm:my-1.5 sm:text-sm text-white",
    ...
    >
      {message.type !== MESSAGE_TYPE_SYSTEM && !isAction(message) && (
        <>
          ...
          <span className="mr-2 font-bold text-white">{getMessagePrefix(message)}</span>
        </>
      )}
