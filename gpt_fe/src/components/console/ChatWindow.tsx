...
const ChatWindow = ({ messages, children, title, chatControls }: ChatWindowProps) => {
  ...
  return (
    <div
      className={clsx(
        "flex h-full w-full max-w-[inherit] flex-1 flex-col overflow-auto rounded-xl border border-gray-700 bg-gray-900 px-4 text-gray-200 shadow-lg transition-all duration-500"
      )}
    >
      <HideShow
