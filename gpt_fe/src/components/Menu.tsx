  ...
  return (
    <MenuPrimitive>
      <div className="relative">
        <MenuPrimitive.Button className="flex h-8 items-center gap-1 rounded-lg p-2 font-bold shadow-depth-1 border border-slate-8 border-opacity-30 hover:bg-shade-500-dark">
          <div>{icon}</div>
...
export const MenuItems = ({ buttonPosition, items, show }: MenuItemsProps) => {
  return (
    ...
    >
      <MenuPrimitive.Items
        className={clsx(
          "absolute right-0 z-20 max-h-48 w-fit  min-w-full overflow-hidden rounded-xl  shadow-xl",
