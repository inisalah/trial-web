  ...
  return (
    <div className="bg-red-500">
      ...
      >
        ...
        <div id="content" className="dark-bg flex min-h-screen w-full items-center justify-center">
          <div
            id="layout"
            className="relative flex h-screen w-full max-w-screen-xl flex-col items-center gap-1 overflow-hidden p-2 pt-3 sm:gap-3 sm:p-4"
          >
            {agent !== null ? (
              <Chat
                messages={messages}
