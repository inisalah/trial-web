...
const SettingsPage = () => {
  ...
  return (
    <DashboardLayout>
      <div className="grid min-h-screen flex-grow place-items-center bg-zinc-900 p-8 sm:p-10 lg:p-10">
        <div className="m-2 rounded-xl border border-shade-500-dark ">
          <FadeIn
            initialX={-45}
            initialY={0}
            delay={0.1}
            className="border-b border-shade-500-dark p-4"
          >
            <div className="align flex justify-between">
              {" "}
              <h1 className="text-3xl font-bold text-slate-5 md:text-4xl">⚙ Settings</h1>
            </div>
          </FadeIn>
          <FadeIn initialY={45} delay={0.1} className="m-4 px-10">
