          ...
          >
            ...
            >
              <HeadlessDialog.Panel
                className={clsx(
                  "relative w-full max-w-sm transform overflow-hidden rounded-lg border-b border-shade-500-dark bg-shade-500-dark text-left shadow-xl transition-all",
              ...
              >
                ...
                <div className={clsx(" px-4 pb-4 pt-5", props.inline || "sm:p-6 sm:pb-4")}>
                ...
                <div className="flex flex-col gap-2 border-t border-shade-500-dark bg-shade-500-dark px-8 py-4">
                  {props.actions}
                </div>
              </HeadlessDialog.Panel>
            </Transition.Child>
